...
Route::group(['prefix'=>'bbb'],function(){
       Route::get('fff1', 'Bbb@fff1');
       Route::get('fff2', 'Bbb@fff2');
...
Route::get('success/{id?}', 'Bbb@success')->name('jjjj');
Route::get('db1', 'Bbb@db1');
Route::get('view1', 'Bbb@view1');
Route::post('bbb1', 'Bbb@bbb1');
Route::any('aaa/{id?}','Bbb@bbb1');

Route::any('models1','Bbb@models1');
/*以下是demo控制器*/
Route::any('demo1','Demo@demo1');
Route::any('demo2','Demo@demo2');
Route::any('demo3/{id?}','Demo@demo3');
Route::any('demo4/{id?}','Demo@demo4');